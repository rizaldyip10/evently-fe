...
const ReferralPage = () => {
    return (
        <div className='w-full flex flex-col gap-10'>
            ...
            {/* <div className='w-1/2 flex flex-col items-center justify-center py-5 px-10 text-center bg-gradient-to-br from-primary-dark to-primary-light gap-5 rounded-[8px] shadow-md'>
