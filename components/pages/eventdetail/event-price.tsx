...
const EventPrice = () => {
    return (
        <div className='hidden w-72 lg:flex flex-col py-5 px-8 border border-light items-center rounded-[8px] gap-4 font-general-sans'>
            ...
            <Button className='w-full p-0 flex justify-center items-center bg-primary-default rounded-[4px] text-primary-white hover:bg-primary-lightest hover:text-primary-default'>
